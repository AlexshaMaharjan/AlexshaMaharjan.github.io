...
const de: Dictionary = {
  ...
  selectedWork: {
    ...
    bento: [
      ...
      { slug: "afono", category: "Marke & E-Commerce", title: "AFONO", gridArea: "1 / 7 / 2 / 11", fontSize: "clamp(22px,2.8vw,44px)" },
      { slug: "sync-fm", category: "Interaction Design", title: "Sync FM", gridArea: "2 / 1 / 3 / 5", fontSize: "clamp(20px,2.3vw,34px)" },
      { slug: "surugami", category: "Marke & Print", title: "Surugami", gridArea: "3 / 1 / 4 / 5", fontSize: "clamp(20px,2.3vw,34px)" },
      { slug: "qis-portal", category: "UX-Research", title: "QIS Portal", gridArea: "2 / 5 / 4 / 11", fontSize: "clamp(26px,3.4vw,56px)" },
      { slug: "barrier-free-kitchen", category: "Inklusives Design", title: "Kitchen", gridArea: "4 / 1 / 6 / 6", fontSize: "clamp(24px,3.1vw,50px)" },
      { slug: "wikimind", category: "Webdesign", title: "WikiMind", gridArea: "4 / 6 / 5 / 11", fontSize: "clamp(20px,2.3vw,36px)" },
      { slug: "afono", category: "Grafik", title: "AFONO", gridArea: "5 / 6 / 6 / 8", fontSize: "clamp(16px,1.6vw,24px)" },
      ...
      { slug: "qis-portal", category: "Produktdesign", title: "QIS Portal", gridArea: "6 / 8 / 7 / 11", fontSize: "clamp(18px,1.9vw,26px)" },
    ],
  },
  projects: [
    {
