...
const crafts: PlaygroundCategoryLocaleContent = {
  en: {
    ...
    items: [
      ...
      { caption: "Explosion box, unfolding", aspect: "3/4", src: "/images/pg-clip-explosion.webp", video: "/videos/pg-gift-explosion.mp4", alt: "Hands unfolding the layers of a black and pink explosion gift box" },
      ...
      { caption: "Pop-up box, opened", aspect: "9/16", src: "/images/pg-clip-popup.webp", video: "/videos/pg-gift-popup.mp4", alt: "A pink and lilac pop-up box being opened, its photo panels standing up" },
      { caption: "Marble keepsake box", aspect: "9/16", src: "/images/pg-clip-riona.webp", video: "/videos/pg-gift-riona.mp4", alt: "A pink marble keepsake box opening to reveal folded paper inside" },
  ...
  de: {
    ...
    items: [
      ...
      { caption: "Explosionsbox beim Öffnen", aspect: "3/4", src: "/images/pg-clip-explosion.webp", video: "/videos/pg-gift-explosion.mp4", alt: "Hände, die die Ebenen einer schwarz-rosa Explosionsbox auffalten" },
      ...
      { caption: "Pop-up-Box, geöffnet", aspect: "9/16", src: "/images/pg-clip-popup.webp", video: "/videos/pg-gift-popup.mp4", alt: "Eine rosa-lila Pop-up-Box wird geöffnet, die Fotoelemente stellen sich auf" },
      { caption: "Marmor-Erinnerungsbox", aspect: "9/16", src: "/images/pg-clip-riona.webp", video: "/videos/pg-gift-riona.mp4", alt: "Eine rosa Marmorbox öffnet sich und gibt gefaltetes Papier frei" },
