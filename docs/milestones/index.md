...
| MILESTONE-005 | Real imagery | **In progress** — 30 of 136 slots filled; pipeline done (SESSION-019) | High | owner's time, not owner's assets | ISSUE-007 ✅, ISSUE-006 | `milestone_005.md` |
