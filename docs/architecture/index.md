...
| ARCH-02 | Content & data model | Current | Typed TS modules: dictionaries, case studies, playground | `architecture_02.md` |
...
| ARCH-05 | Image & asset handling | Current | Custom `Image`, `PlaceholderImage`, `public/images`, no pipeline | `architecture_05.md` |
