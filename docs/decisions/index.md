...
| DECISION-025 | One uniform card, nothing cropped, matted in the image's own colour | **Active** | Playground index and category grids | 36% of every image was being discarded by a hard-coded `object-cover` aspect; a 3/4 box (median aspect 0.762) with a build-time sampled mat leaves 19% and crops nothing. One row moves at a time | `decision_025.md` |
