...
| SUGGESTION-017 | A lone narrow figure should not take the full reading column | Proposed | **Medium** — hit twice, worked around twice | Medium | Small | M-005 | `suggestion_017.md` |
