...
| SUGGESTION-017 | A lone narrow figure should not take the full reading column | **Superseded** by `DECISION-019` (SESSION-027) | **Medium** — hit twice, worked around twice | Medium | Small | M-005 | `suggestion_017.md` |
